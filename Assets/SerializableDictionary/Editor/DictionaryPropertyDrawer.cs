...
namespace RotaryHeart.Lib.SerializableDictionary
{
    ...
    public class DictionaryPropertyDrawer : PropertyDrawer
    {
        ...
        private void List_drawElementCallback(Rect rect, SerializedProperty element, GUIContent label, int index, bool selected, bool focused)
        {
            ...
            Rect keyRect = new Rect(rect.x + 16, rect.y + 4, rect.width / 3f, rect.height);
            ...
            if ((containsAttribute && !string.IsNullOrEmpty(propName)) || keyToUse.propertyType != SerializedPropertyType.Generic)
            {
                ...
                //EditorGUI.LabelField(new Rect(rect.x + 5, keyRect.y, 15, rect.height), idContent); 
                // EditorGUI.Foldout(new Rect(rect.x + 15, keyRect.y, 20, rect.height), keyProp.isExpanded, idContent, true);
            }
            ...
            valueRect.y = keyRect.yMin;
            valueRect.x += keyRect.xMax - 30;
            valueRect.width = rect.width - keyRect.xMax;
            ...
            else
            {
                ...
                //{
                    ...
                    {
                        EditorGUI.BeginChangeCheck();
                        var newV4 = EditorGUI.Vector4Field(new Rect(valueRect.x, valueRect.y, valueRect.width, valueRect.height), GUIContent.none, QuaternionToVector4(valueProp.quaternionValue));
                    ...
                    {
                        EditorGUI.PropertyField(new Rect(valueRect.x, valueRect.y, valueRect.width, valueRect.height), valueProp, GUIContent.none, true);
                    }
                    EditorGUI.EndProperty();
                //}
            }
